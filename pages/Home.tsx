  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              ...
              <mark className="bg-blue-200">professional development</mark> in
              the region. We are dedicated to providing a forum where engineers
              can exchange knowledge, participate in{" "}
              <mark className="bg-blue-200">technical seminars</mark>, and shape
              the future of{" "}
              <mark className="bg-blue-200">local infrastructure</mark>.
            </p>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #003d82 0%, #0052a3 50%, #006fc4 100%)",
        }}
      >
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              ...
              Reiciendis dignissimos eoque dolorumque, nulla mollitia facilis
              temporibus ullam voluptas nostrum consequatur? Fugiat vitae sint
              qu est everiet perspicidis aum osperiones ipsum.
            </p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center flex-shrink-0">
                  <MapPin size={24} className="text-iei-primary" />
                </div>
                <div>
                  <h3 className="text-iei-accent font-bold text-lg mb-2">
                    Address
                  </h3>
                  <p className="text-gray-300">
                    IEI Salem Center Road,
                    <br />
                    Ovatonina, Minnesota,
                    <br />
                    55000
              ...
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center flex-shrink-0">
                  <Phone size={24} className="text-iei-primary" />
                </div>
                <div>
                  <h3 className="text-iei-accent font-bold text-lg mb-2">
                    Phone
                  </h3>
                  <p className="text-gray-300">501-456-0281</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center flex-shrink-0">
                  <Mail size={24} className="text-iei-primary" />
                </div>
                <div>
                  <h3 className="text-iei-accent font-bold text-lg mb-2">
                    Email
              ...
              <form className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full px-0 py-3 bg-transparent text-gray-800 border-b border-gray-300 focus:outline-none focus:border-iei-primary placeholder-gray-500"
                  />
                </div>
                <div>
                  <input
                ...
                <div>
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-0 py-3 bg-transparent text-gray-800 border-b border-gray-300 focus:outline-none focus:border-iei-primary placeholder-gray-500 resize-none"
                  ></textarea>
                </div>
                <button
                  type="submit"
                  className="w-full mt-6 bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-3 rounded transition-colors"
                >
                  Send
                </button>
              </form>
