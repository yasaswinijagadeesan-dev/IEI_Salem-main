...
const About: React.FC = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      description:
        "Embraced technology for better member engagement and knowledge sharing.",
    },
    {
      year: "2024",
      title: "Modern Era",
  ...
  const coreValues = [
    {
      ...
      title: "Excellence",
      description:
        "Striving for the highest standards in engineering practice and education.",
    },
    {
      icon: <Heart size={32} />,
      title: "Integrity",
      description:
        "Upholding ethical principles and professional conduct in all endeavors.",
    },
    {
      icon: <Lightbulb size={32} />,
      title: '<mark className="bg-blue-200">Innovation</mark>',
      description:
        "Fostering creativity and embracing new technologies and methodologies.",
    },
    {
      icon: <Shield size={32} />,
      title: "Professionalism",
      description:
        "Maintaining the dignity and reputation of the engineering profession.",
    },
    {
      icon: <TrendingUp size={32} />,
      title: "Growth",
      description:
        "Continuous learning and development for members and the community.",
    },
    {
      icon: <Users size={32} />,
      title: "Collaboration",
      description:
        "Building strong partnerships and networks within the engineering fraternity.",
    },
  ];
  ...
  return (
    <div>
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-200 animate-fade-in-up delay-100">
            Empowering Engineers <mark className="bg-blue-200">Since 1965</mark>
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <mark className="bg-blue-200">since 1965</mark>. As part of the
                world's largest multi-disciplinary professional body, we serve
                as a vital platform for{" "}
                <mark className="bg-blue-200">knowledge exchange</mark>,
                networking, and career advancement.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                Our centre brings together engineers from diverse disciplines -
                Civil, Mechanical, Electrical, Electronics, Computer Science,
                and more - fostering collaboration and{" "}
                <mark className="bg-blue-200">innovation</mark> that drives
                regional infrastructure and{" "}
                <mark className="bg-blue-200">industrial growth</mark>.
              </p>
              <div className="bg-iei-primary/5 border-l-4 border-iei-primary p-6 rounded-r-lg">
                <p className="text-iei-primary font-semibold text-lg italic">
                  ...
                  engineering and technology for the benefit of the community."
                </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-iei-primary mt-2">
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                ...
                >
                  <div
                    className={`flex-1 ${index % 2 === 0 ? "md:text-right" : "md:text-left"} animate-fade-in-up`}
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                      <h3 className="text-2xl font-bold text-iei-primary mb-2">
                        {item.title}
                      </h3>
                  ...
                  >
                    <span className="text-3xl font-bold text-iei-accent">
                      {item.year}
                    </span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white border-2 border-iei-primary p-10 rounded-2xl shadow-xl animate-fade-in-up hover:shadow-2xl transition-shadow">
              ...
              <h3 className="text-3xl font-bold mb-4 text-iei-primary">
                Our Vision
              </h3>
              <p className="text-gray-700 leading-relaxed">
                To be the premier professional body for engineers in Salem,
                recognized for excellence in technical knowledge dissemination,
                professional development, and contribution to society's
            ...
            <div className="bg-white border-2 border-iei-primary p-10 rounded-2xl shadow-xl animate-fade-in-up delay-100 hover:shadow-2xl transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed">
                To promote and advance the science and practice of engineering
                through continuous learning, ethical practice, and collaborative
                innovation, while serving the professional needs of our members
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-iei-primary font-bold tracking-widest text-xs uppercase">
              What We Stand For
            </span>
            <h2 className="text-4xl font-bold text-iei-primary mt-2">
              Core Values
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreValues.map((value, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-iei-primary mb-3">
                  {value.title}
                </h3>
      ...
      <section id="stats-section" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold mb-4 text-iei-primary">
              Our Impact in Numbers
            </h2>
            <p className="text-gray-700 text-lg">
              Serving the engineering community with dedication and excellence
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white border-2 border-iei-primary p-8 rounded-xl text-center shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2"
              >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-iei-primary mt-2 mb-4">
              Governance & Management
            </h2>
            <p className="text-gray-700 max-w-3xl mx-auto">
              Our centre is led by a dedicated team of experienced engineers who
              volunteer their time and expertise to serve the engineering
              community.
            </p>
          </div>
          ...
          <div className="bg-white border-2 border-iei-primary p-10 rounded-2xl text-center shadow-xl">
            ...
            <h3 className="text-2xl font-bold text-iei-primary mb-4">
              Executive Committee 2025-2027
            </h3>
            <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
              Our Executive Committee comprises distinguished engineers from
              various disciplines, working together to advance the institution's
              objectives and serve our members.
            </p>
            <Link
              to="/committee"
